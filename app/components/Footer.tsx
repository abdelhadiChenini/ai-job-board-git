...
export async function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-navy" aria-label="Footer">
      <div className="mx-auto w-full max-w-[1400px] px-6 py-8 md:px-12">
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            <div className="mt-6 flex items-center gap-3">
              {seoSettings?.linkedinUrl && (
                <a
                  href={seoSettings.linkedinUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="border border-slate-800 bg-slate-900 p-2 rounded-lg transition-colors hover:border-slate-600"
                >
              ...
              {seoSettings?.twitterUrl && (
                <a
                  href={seoSettings.twitterUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="X (Twitter)"
                  className="border border-slate-800 bg-slate-900 p-2 rounded-lg transition-colors hover:border-slate-600"
                >
                  <TwitterIcon className="h-4 w-4 text-slate-400" />
                </a>
              )}
              {seoSettings?.instagramUrl && (
                <a
                  href={seoSettings.instagramUrl}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              {seoSettings?.youtubeUrl && (
                <a
                  href={seoSettings.youtubeUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="border border-slate-800 bg-slate-900 p-2 rounded-lg transition-colors hover:border-slate-600"
                >
                  <YoutubeIcon className="h-4 w-4 text-slate-400" />
                </a>
              )}
            </div>
          </div>
